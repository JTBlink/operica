-- Add a per-installation `region` so one Opercia deployment can serve
...
-- deployment-wide value (the OPERCIA_LARK_HTTP_BASE_URL /
-- OPERCIA_LARK_CALLBACK_BASE_URL env knobs, defaulting to open.feishu.cn),
