-- Add a per-installation `region` so one Operica deployment can serve
...
-- deployment-wide value (the OPERICA_LARK_HTTP_BASE_URL /
-- OPERICA_LARK_CALLBACK_BASE_URL env knobs, defaulting to open.feishu.cn),
