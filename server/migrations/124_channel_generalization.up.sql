...
--
--     PRD (rolling opercia-api, maxUnavailable:0) overlapped old and new pods.
--     A one-time OPERCIA_LARK_HUB_DISABLED park-switch existed during the
...
CREATE INDEX idx_channel_user_binding_user
    ON channel_user_binding(opercia_user_id, workspace_id);
...
INSERT INTO channel_user_binding (
    id, workspace_id, opercia_user_id, installation_id,
