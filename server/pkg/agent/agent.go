...
type ExecOptions struct {
	Cwd   string
	Model string
	// SystemPrompt carries the Operica runtime brief for the few providers
	...
	// went stale as backends were added, which is how OPERICA_QWENPAW_ARGS
...
// be based on a backend Operica officially supports.
