...
const (
	opencodeStdinHelperEnv      = "OPERICA_OPENCODE_STDIN_HELPER"
	opencodeStdinHelperArgvFile = "OPERICA_OPENCODE_STDIN_HELPER_ARGV_FILE"
	opencodeStdinHelperInFile   = "OPERICA_OPENCODE_STDIN_HELPER_STDIN_FILE"
)
