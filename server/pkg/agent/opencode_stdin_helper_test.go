...
const (
	opencodeStdinHelperEnv      = "OPERCIA_OPENCODE_STDIN_HELPER"
	opencodeStdinHelperArgvFile = "OPERCIA_OPENCODE_STDIN_HELPER_ARGV_FILE"
	opencodeStdinHelperInFile   = "OPERCIA_OPENCODE_STDIN_HELPER_STDIN_FILE"
)
