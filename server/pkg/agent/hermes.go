...
// file write on the Hermes ACP runtime (GitHub opercia#5300).
...
// GitHub opercia#5300 it refuses to auto-select a permanent "allow_always"
...
// even when Opercia did not pass an explicit agent.model override.
...
// files use instead of Opercia's canonical `mcpServers`: jcode and Kiro
...
// opercia#5862 — do not gate matching on length).
