...
// file write on the Hermes ACP runtime (GitHub operica#5300).
...
// GitHub operica#5300 it refuses to auto-select a permanent "allow_always"
...
// even when Operica did not pass an explicit agent.model override.
...
// files use instead of Operica's canonical `mcpServers`: jcode and Kiro
...
// operica#5862 — do not gate matching on length).
