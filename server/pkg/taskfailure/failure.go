...
// ([MUL-2946](https://operica/issues/MUL-2946)). Subsequent PRs use
...
const (
	// Platform / scheduler side: failure attributable to Operica
	...
	// message. Treated as platform-side because it is a Operica-imposed
