...
// ([MUL-2946](https://opercia/issues/MUL-2946)). Subsequent PRs use
...
const (
	// Platform / scheduler side: failure attributable to Opercia
	...
	// message. Treated as platform-side because it is a Opercia-imposed
