...
func TestRunRepoCheckoutForwardsManagedCheckoutMode(t *testing.T) {
	...
	t.Setenv("OPERCIA_DAEMON_PORT", strings.TrimPrefix(srv.URL, "http://127.0.0.1:"))
	t.Setenv("OPERCIA_WORKSPACE_ID", "ws-1")
	t.Setenv("OPERCIA_AGENT_NAME", "Test Agent")
	t.Setenv("OPERCIA_TASK_ID", "task-1")
	t.Setenv("OPERCIA_REPO_CHECKOUT_MODE", "isolated")
