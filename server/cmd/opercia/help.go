...
var rootHelpTemplate = `Work seamlessly with Opercia from the command line.

USAGE
  opercia <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
EXAMPLES
  ...
  $ opercia agent list --output json

ENVIRONMENT VARIABLES
  OPERCIA_SERVER_URL    Override the default server URL
  OPERCIA_WORKSPACE_ID  Set the active workspace

LEARN MORE
  Use ` + "`opercia <command> <subcommand> --help`" + ` for more information about a command.
`
