...
// opercia property {list|get|create|update|archive|unarchive} — workspace
// custom property definitions, and opercia issue property {list|set|unset} —
...
date, checkbox, url. Select types take repeatable --option flags:
  opercia property create --name Severity --type select \
