...
// operica property {list|get|create|update|archive|unarchive} — workspace
// custom property definitions, and operica issue property {list|set|unset} —
...
date, checkbox, url. Select types take repeatable --option flags:
  operica property create --name Severity --type select \
