...
var rootHelpTemplate = `Work seamlessly with Operica from the command line.

USAGE
  operica <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
EXAMPLES
  ...
  $ operica agent list --output json

ENVIRONMENT VARIABLES
  OPERICA_SERVER_URL    Override the default server URL
  OPERICA_WORKSPACE_ID  Set the active workspace

LEARN MORE
  Use ` + "`operica <command> <subcommand> --help`" + ` for more information about a command.
`
