...
func TestRunRuntimeProfileList(t *testing.T) {
	...
	t.Setenv("OPERICA_WORKSPACE_ID", "ws-123")
...
func TestRunRuntimeProfileSetPathPreservesExistingConfig(t *testing.T) {
	...
	seed := cli.CLIConfig{ServerURL: "https://api.operica.ai", WorkspaceID: "ws-123", Token: "mul_xyz"}
	...
	if cfg.ServerURL != "https://api.operica.ai" || cfg.WorkspaceID != "ws-123" || cfg.Token != "mul_xyz" {
