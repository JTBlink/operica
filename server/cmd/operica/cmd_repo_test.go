...
func TestRunRepoCheckoutForwardsManagedCheckoutMode(t *testing.T) {
	...
	t.Setenv("OPERICA_DAEMON_PORT", strings.TrimPrefix(srv.URL, "http://127.0.0.1:"))
	t.Setenv("OPERICA_WORKSPACE_ID", "ws-1")
	t.Setenv("OPERICA_AGENT_NAME", "Test Agent")
	t.Setenv("OPERICA_TASK_ID", "task-1")
	t.Setenv("OPERICA_REPO_CHECKOUT_MODE", "isolated")
