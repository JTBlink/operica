...
// in the operica binary. The daemon runs Prepare/Reuse in that subprocess so a
...
const PreparationHelperArg = "__operica_execenv_prepare"
...
// name the current operica binary followed by PreparationHelperArg in
