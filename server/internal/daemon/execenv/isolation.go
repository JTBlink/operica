...
// in the opercia binary. The daemon runs Prepare/Reuse in that subprocess so a
...
const PreparationHelperArg = "__opercia_execenv_prepare"
...
// name the current opercia binary followed by PreparationHelperArg in
