...
//   - populates the task-local `skills/` dir with ONLY the Opercia-bound skills,
...
//     Opercia product concern — the host's local Hermes memory must not bleed
...
const hermesTaskLocalStateMarker = ".opercia-task-local-state-v1"
...
// Opercia-bound skills. They keep their natural slug (no user skills share this
