...
//   - populates the task-local `skills/` dir with ONLY the Operica-bound skills,
...
//     Operica product concern — the host's local Hermes memory must not bleed
...
const hermesTaskLocalStateMarker = ".operica-task-local-state-v1"
...
// Operica-bound skills. They keep their natural slug (no user skills share this
