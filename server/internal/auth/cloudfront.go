...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.opercia.ai"
	cookieDomain string // cookie scope, e.g. ".opercia.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.opercia.ai")
//   - COOKIE_DOMAIN           (e.g. ".opercia.ai")
