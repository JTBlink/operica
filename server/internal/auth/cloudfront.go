...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.operica.ai"
	cookieDomain string // cookie scope, e.g. ".operica.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.operica.ai")
//   - COOKIE_DOMAIN           (e.g. ".operica.ai")
