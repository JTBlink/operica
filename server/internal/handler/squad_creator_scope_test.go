...
func TestCreateSquad_PlainMemberBecomesCreator(t *testing.T) {
	...
	memberID := createPlainMember(t, "squad-creator@opercia.test")
...
func TestManageSquad_CreatorCanManageOwn(t *testing.T) {
	...
	memberID := createPlainMember(t, "squad-owner-manage@opercia.test")
...
func TestManageSquad_StrangerMemberForbidden(t *testing.T) {
	...
	creatorID := createPlainMember(t, "squad-stranger-creator@opercia.test")
	strangerID := createPlainMember(t, "squad-stranger-other@opercia.test")
