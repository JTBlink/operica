...
func TestRelativeWorkDir(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			workDir:  "/Users/alice/operica_workspaces/" + wsID + "/5c57b65b/workdir",
			wsID:     wsID,
			taskID:   taskID,
		...
		},
		{
			...
			workDir:  "/Users/alice/operica_workspaces/" + wsID + "/5c57b65b",
			wsID:     wsID,
			taskID:   taskID,
		...
		},
		{
			...
			workDir:  "/Users/df007df/code/work/projects/operica/foo",
			wsID:     wsID,
			taskID:   taskID,
			expected: "code/work/projects/operica/foo",
		},
		{
		...
		},
		{
			...
			workDir:  `C:\Users\alice\operica_workspaces\` + wsID + `\5c57b65b\workdir`,
			wsID:     wsID,
			taskID:   taskID,
			expected: wsID + "/5c57b65b/workdir",
		},
		{
			...
			wsID:     "",
			taskID:   taskID,
			expected: "operica_workspaces/" + wsID + "/5c57b65b/workdir",
		},
		{
