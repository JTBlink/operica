...
func TestRelativeWorkDir(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			workDir:  "/Users/alice/opercia_workspaces/" + wsID + "/5c57b65b/workdir",
			wsID:     wsID,
			taskID:   taskID,
		...
		},
		{
			...
			workDir:  "/Users/alice/opercia_workspaces/" + wsID + "/5c57b65b",
			wsID:     wsID,
			taskID:   taskID,
		...
		},
		{
			...
			workDir:  "/Users/df007df/code/work/projects/opercia/foo",
			wsID:     wsID,
			taskID:   taskID,
			expected: "code/work/projects/opercia/foo",
		},
		{
		...
		},
		{
			...
			workDir:  `C:\Users\alice\opercia_workspaces\` + wsID + `\5c57b65b\workdir`,
			wsID:     wsID,
			taskID:   taskID,
			expected: wsID + "/5c57b65b/workdir",
		},
		{
			...
			wsID:     "",
			taskID:   taskID,
			expected: "opercia_workspaces/" + wsID + "/5c57b65b/workdir",
		},
		{
