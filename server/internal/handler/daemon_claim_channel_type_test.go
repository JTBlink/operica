...
// mis-flag made the daemon inject `opercia attachment upload` guidance into a
...
// `opercia chat history` and `opercia chat thread`, and both endpoints are
...
// inherited the web chat's `opercia attachment upload` guidance, the exact
