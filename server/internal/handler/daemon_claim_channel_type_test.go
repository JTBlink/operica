...
// mis-flag made the daemon inject `operica attachment upload` guidance into a
...
// `operica chat history` and `operica chat thread`, and both endpoints are
...
// inherited the web chat's `operica attachment upload` guidance, the exact
