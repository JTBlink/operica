...
func NewBusinessMetrics() *BusinessMetrics {
	...
	m := &BusinessMetrics{
		...
		}, metricLabels("opercia_agent_task_queue_wait_seconds")),
		taskRunSeconds: prometheus.NewHistogramVec(prometheus.HistogramOpts{
			...
			Buckets:   taskDurationBuckets,
		}, metricLabels("opercia_agent_task_run_seconds")),
		taskTotalSeconds: prometheus.NewHistogramVec(prometheus.HistogramOpts{
			...
			Buckets:   taskDurationBuckets,
		}, metricLabels("opercia_agent_task_total_seconds")),
		...
		}, metricLabels("opercia_agent_task_in_progress")),
		...
		}, metricLabels("opercia_llm_unpriced_tokens_total")),
		...
		}, metricLabels("opercia_llm_request_total")),
		...
		}, metricLabels("opercia_task_queued_expired_total")),
		...
		}, metricLabels("opercia_task_lease_expired_total")),
		activeTasks: map[string]activeTaskLabels{},
