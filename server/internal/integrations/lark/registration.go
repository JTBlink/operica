...
//     and an expiry. Operica renders the QR, the user scans it in the
...
type RegistrationConfig struct {
	...
	// telemetry can attribute installs back to Operica. Empty defaults
	// to "operica".
	Source string
...
type BeginResult struct {
	DeviceCode string
	// QRCodeURL is the verification_uri_complete with Operica's `source`
...
// cannot attribute installs back to Operica in their analytics.
//
