...
//     and an expiry. Opercia renders the QR, the user scans it in the
...
type RegistrationConfig struct {
	...
	// telemetry can attribute installs back to Opercia. Empty defaults
	// to "opercia".
	Source string
...
type BeginResult struct {
	DeviceCode string
	// QRCodeURL is the verification_uri_complete with Opercia's `source`
...
// cannot attribute installs back to Opercia in their analytics.
//
