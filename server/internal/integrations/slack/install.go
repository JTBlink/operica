...
// app-level token (xapp-) into Opercia (the paste path lives in byo_install.go).
...
var (
	...
	// already connected to a live owner in a DIFFERENT Opercia workspace — it
	...
	ErrTeamOwnedByAnotherWorkspace = errors.New("slack: this Slack app is already connected to a different Opercia workspace")
...
// the pasted Slack app is already connected to a DIFFERENT agent or Opercia
