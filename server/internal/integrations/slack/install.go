...
// app-level token (xapp-) into Operica (the paste path lives in byo_install.go).
...
var (
	...
	// already connected to a live owner in a DIFFERENT Operica workspace — it
	...
	ErrTeamOwnedByAnotherWorkspace = errors.New("slack: this Slack app is already connected to a different Operica workspace")
...
// the pasted Slack app is already connected to a DIFFERENT agent or Operica
