...
const DB = process.env.DATABASE_URL || "postgres://operica:operica@localhost:5432/operica_operica_101?sslmode=disable";
...
async function main() {
  ...
  await page.evaluate((t) => localStorage.setItem("operica_token", t), token);
