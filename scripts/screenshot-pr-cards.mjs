...
const DB = process.env.DATABASE_URL || "postgres://opercia:opercia@localhost:5432/opercia_opercia_101?sslmode=disable";
...
async function main() {
  ...
  await page.evaluate((t) => localStorage.setItem("opercia_token", t), token);
