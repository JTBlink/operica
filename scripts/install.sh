...
# Configuration
# ---------------------------------------------------------------------------
REPO_URL="https://github.com/opercia-ai/opercia.git"
REPO_WEB_URL="https://github.com/opercia-ai/opercia"  # without .git, for GitHub web APIs
...
install_cli_binary() {
  ...
  local url="https://github.com/opercia-ai/opercia/releases/download/${latest}/opercia-cli-${version}-${OS}-${ARCH}.tar.gz"
  local tmp_dir
  tmp_dir=$(mktemp -d)
...
run_default() {
  ...
  printf "     curl -fsSL https://raw.githubusercontent.com/opercia-ai/opercia/main/scripts/install.sh | bash -s -- --with-server\n"
  printf "\n"
}
...
run_with_server() {
  ...
  printf "     curl -fsSL https://raw.githubusercontent.com/opercia-ai/opercia/main/scripts/install.sh | bash -s -- --stop\n"
  printf "\n"
}
