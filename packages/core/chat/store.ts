...
const AGENT_STORAGE_KEY = "opercia:chat:selectedAgentId";
const PROJECT_STORAGE_KEY = "opercia:chat:selectedProjectId";
const SESSION_STORAGE_KEY = "opercia:chat:activeSessionId";
/** Drafts are stored as one JSON blob per workspace: { [sessionId]: text }. */
const DRAFTS_KEY = "opercia:chat:drafts";
/** Draft attachment records per workspace: { [sessionId]: Attachment[] }. */
const DRAFT_ATTACHMENTS_KEY = "opercia:chat:draft-attachments";
/**
 ...
 */
const APPLIED_RESTORES_KEY = "opercia:chat:applied-draft-restores";
/**
 ...
 */
const PENDING_SEND_RESTORES_KEY = "opercia:chat:pending-send-restores";
/**
...
const CHAT_WIDTH_KEY = "opercia:chat:width";
const CHAT_HEIGHT_KEY = "opercia:chat:height";
const CHAT_EXPANDED_KEY = "opercia:chat:expanded";
/**
 ...
 */
const OPEN_KEY = "opercia:chat:isOpen";
/**
 ...
 */
const FLOATING_KEY = "opercia:chat:floatingChatEnabled";
