...
const AGENT_STORAGE_KEY = "operica:chat:selectedAgentId";
const PROJECT_STORAGE_KEY = "operica:chat:selectedProjectId";
const SESSION_STORAGE_KEY = "operica:chat:activeSessionId";
/** Drafts are stored as one JSON blob per workspace: { [sessionId]: text }. */
const DRAFTS_KEY = "operica:chat:drafts";
/** Draft attachment records per workspace: { [sessionId]: Attachment[] }. */
const DRAFT_ATTACHMENTS_KEY = "operica:chat:draft-attachments";
/**
 ...
 */
const APPLIED_RESTORES_KEY = "operica:chat:applied-draft-restores";
/**
 ...
 */
const PENDING_SEND_RESTORES_KEY = "operica:chat:pending-send-restores";
/**
...
const CHAT_WIDTH_KEY = "operica:chat:width";
const CHAT_HEIGHT_KEY = "operica:chat:height";
const CHAT_EXPANDED_KEY = "operica:chat:expanded";
/**
 ...
 */
const OPEN_KEY = "operica:chat:isOpen";
/**
 ...
 */
const FLOATING_KEY = "operica:chat:floatingChatEnabled";
