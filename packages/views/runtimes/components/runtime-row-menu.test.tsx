...
import type { AgentRuntime, RuntimeProfile } from "@operica/core/types";
...
vi.mock("@operica/core/runtimes/mutations", () => ({
...
describe("runtime list CLI column", () => {
  ...
  // shared operica daemon `cli_version`. It must instead show the agent's own
