...
import type { AgentRuntime, RuntimeProfile } from "@opercia/core/types";
...
vi.mock("@opercia/core/runtimes/mutations", () => ({
...
describe("runtime list CLI column", () => {
  ...
  // shared opercia daemon `cli_version`. It must instead show the agent's own
