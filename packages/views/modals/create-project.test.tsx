...
const longRepoUrl =
  "https://github.com/opercia-ai/a-very-long-repository-name-that-needs-a-tooltip";
const apiRepoUrl = "https://github.com/opercia-ai/api";
const webRepoUrl = "https://github.com/opercia-ai/web";
