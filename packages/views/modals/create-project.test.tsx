...
const longRepoUrl =
  "https://github.com/operica-ai/a-very-long-repository-name-that-needs-a-tooltip";
const apiRepoUrl = "https://github.com/operica-ai/api";
const webRepoUrl = "https://github.com/operica-ai/web";
