...
// Mock @operica/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@operica/core/issues/stores/view-store", () => ({
...
vi.mock("@operica/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@operica/core/issues/stores/selection-store", () => ({
...
vi.mock("@operica/core/issues/stores/recent-issues-store", () => ({
