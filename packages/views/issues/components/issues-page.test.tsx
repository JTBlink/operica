...
// Mock @opercia/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@opercia/core/issues/stores/view-store", () => ({
...
vi.mock("@opercia/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@opercia/core/issues/stores/selection-store", () => ({
...
vi.mock("@opercia/core/issues/stores/recent-issues-store", () => ({
