...
import { slackInstallationsOptions, slackKeys } from "@operica/core/slack";
import { api } from "@operica/core/api";
import type { SlackInstallation } from "@operica/core/types";
...
// path is per-agent (each Operica agent gets exactly one bot — the
  ...
  const prefix = lang?.startsWith("zh")
    ...
    : lang?.startsWith("ja")
      ...
      : lang?.startsWith("ko")
        ? "/ko"
        : "";
  return `https://operica.ai/docs${prefix}/slack-bot-integration`;
}
