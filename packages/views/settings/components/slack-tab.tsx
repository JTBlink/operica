...
import { slackInstallationsOptions, slackKeys } from "@opercia/core/slack";
import { api } from "@opercia/core/api";
import type { SlackInstallation } from "@opercia/core/types";
...
// path is per-agent (each Opercia agent gets exactly one bot — the
  ...
  const prefix = lang?.startsWith("zh")
    ...
    : lang?.startsWith("ja")
      ...
      : lang?.startsWith("ko")
        ? "/ko"
        : "";
  return `https://opercia.ai/docs${prefix}/slack-bot-integration`;
}
