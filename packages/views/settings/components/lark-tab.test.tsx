...
// ApiError is re-exported from @operica/core/api; we mock the api module
...
// row uses it to render the Operica agent's name in place of the raw
...
// renders the Operica agent's avatar + name (joined via inst.agent_id),
...
describe("LarkTab connected bots list (agent identity rendering)", () => {
  ...
  it("renders the Operica agent's name and avatar instead of the raw Lark app_id / bot_open_id", () => {
