...
import type { RuntimeModelThinkingLevel } from "@opercia/core/types";
 ...
 * the user's local CLI install, not by Opercia's catalog.
 */
      ...
      {levels.map((l) => (
        ...
        >
          ...
          {/* No model-factory-default badge here on purpose: when the
              picker is "Follow CLI config" (value === ""), Opercia omits
