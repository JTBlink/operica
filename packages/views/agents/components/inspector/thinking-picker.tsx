...
import type { RuntimeModelThinkingLevel } from "@operica/core/types";
 ...
 * the user's local CLI install, not by Operica's catalog.
 */
      ...
      {levels.map((l) => (
        ...
        >
          ...
          {/* No model-factory-default badge here on purpose: when the
              picker is "Follow CLI config" (value === ""), Operica omits
