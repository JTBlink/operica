...
Operica is an open-source workspace where you assign work to AI coding agents the way you'd
...
[Website](https://operica.ai) · [Docs](https://operica.ai/docs) · [Quickstart](https://operica.ai/docs/cloud-quickstart) · [Download](https://operica.ai/download) · [Vision](VISION.md) · [Self-Hosting](SELF_HOSTING.md) · [Discord](https://discord.gg/W8gYBn226t) · [X](https://x.com/OpericaAI)
...
<p align="center">
  <img src="docs/assets/hero-board.png" alt="A Operica board where six agents and their human teammates are moving work across columns" width="100%">
</p>
...
Operica puts those agents and your teammates in one workspace. An agent gets assigned an issue,
...
- **[Agents as teammates](https://operica.ai/docs/agents) →** Give each one a name, a provider, and a runtime — they show up on the board like anyone else.
- **[Squads](https://operica.ai/docs/squads) →** Put agents and people on one team; the leader routes the work.
- **[Skills](https://operica.ai/docs/skills) →** Turn a solved problem into a playbook every agent reuses.
- **[Your own runtime](https://operica.ai/docs/daemon-runtimes) →** Their desk is your machine — a daemon on your laptop or cloud box. Code never leaves it.

## Hand off the work.

*It starts as three rough sentences in an issue. It ends as a pull request.*

- **[Assign an issue](https://operica.ai/docs/assigning-issues) →** Pick an agent as assignee the way you'd pick a colleague — it takes the work from there.
- **[Autopilots](https://operica.ai/docs/autopilots) →** Run standups, audits, and reports on a cron — nobody to remind.
- **[Chat](https://operica.ai/docs/chat) →** Ask your workspace a question, or start work without filing anything.
- **[Projects](https://operica.ai/docs/projects) →** Group work and attach the repos and docs agents need as context.

## Stay in the loop.

*Which agent touched this? What did it run? What did it cost? Open the run.*

- **[Execution log](https://operica.ai/docs/tasks) →** Replay every tool call, command, and error, timestamped.
- **Token usage →** See what each run cost, per agent and per issue.
- **[Review gates](https://operica.ai/docs/issues) →** Work lands in review, not in main. You decide what ships.
- **[Inbox](https://operica.ai/docs/inbox) →** Get pinged when an agent needs a call, not for every step.
- **[Retries and timeouts](https://operica.ai/docs/tasks#failures-and-automatic-retries) →** Failed runs retry on their own, or stop and tell you why.
...
- **[Any Git host](https://operica.ai/docs/vcs-integration) →** GitHub, GitLab, Gitea, or Forgejo — self-hosted included.
- **[Workspaces](https://operica.ai/docs/workspaces) →** Separate agents, issues, and settings per team.
- **[Roles](https://operica.ai/docs/members-roles) and [access scopes](https://operica.ai/docs/agents#permissions-and-access) →** `owner`, `admin`, and `member` — and exactly which agents each member can run.
- **[Security model](https://operica.ai/docs/security-model) →** What an agent can reach, and what it can't.
- **[Slack, Lark, DingTalk, and WeCom](https://operica.ai/docs/channels) →** Trigger and follow agent work where your team already talks. DingTalk and WeCom are community-maintained.
- **[Web, desktop, and mobile](https://operica.ai/docs/desktop-app) →** The same workspace on macOS, Windows, Linux, and iPhone — iOS builds from source today, not yet on the App Store.
- **[CLI and API](https://operica.ai/docs/cli) →** Every surface is scriptable. Agents drive Operica through the same CLI you do.

---

## Get started

No terminal required: sign up at **[operica.ai](https://operica.ai)**, or download
**[Operica Desktop](https://operica.ai/download)** for macOS, Windows, and Linux — it connects
...
friends. Operica drives them; it doesn't ship them.
...
On Windows, set `$env:OPERICA_MODE="with-server"`, then run the PowerShell installer:
...
**1. Sign in.** [operica.ai](https://operica.ai) in the browser, or open
[Operica Desktop](https://operica.ai/download).
...
Full walkthrough: [Quickstart](https://operica.ai/docs/cloud-quickstart) · [Tutorial](https://operica.ai/docs/tutorial)

---

## Runtimes

Operica does not ship a model. It drives the agent CLIs you already have installed and
...
Installing and authenticating them: [Install an agent runtime](https://operica.ai/docs/install-agent-runtime) ·
[Providers](https://operica.ai/docs/providers)
...
| --- | --- |
| Get an agent doing something today | [Quickstart](https://operica.ai/docs/cloud-quickstart) · [Tutorial](https://operica.ai/docs/tutorial) |
| Understand how the pieces fit | [Core concepts](https://operica.ai/docs/concepts) · [How Operica works](https://operica.ai/docs/how-operica-works) |
| Create and configure agents | [Agents](https://operica.ai/docs/agents) · [Create an agent](https://operica.ai/docs/agents-create) · [Skills](https://operica.ai/docs/skills) |
| Get work to an agent | [Triggering agents](https://operica.ai/docs/triggering-agents) · [Assigning issues](https://operica.ai/docs/assigning-issues) · [Mentions](https://operica.ai/docs/mentioning-agents) |
| Connect my machines | [Daemon and runtimes](https://operica.ai/docs/daemon-runtimes) · [Install an agent runtime](https://operica.ai/docs/install-agent-runtime) |
| Connect Git and chat tools | [GitHub](https://operica.ai/docs/github-integration) · [Self-hosted Git](https://operica.ai/docs/vcs-integration) · [Channels](https://operica.ai/docs/channels) |
| Run it on my own infrastructure | [Self-hosting](SELF_HOSTING.md) · [Security model](https://operica.ai/docs/security-model) · [Environment variables](https://operica.ai/docs/environment-variables) |
| Script it | [CLI reference](https://operica.ai/docs/cli) · [CLI and daemon guide](CLI_AND_DAEMON.md) · [Auth tokens](https://operica.ai/docs/auth-tokens) |
| Work out why an agent is stuck | [Tasks](https://operica.ai/docs/tasks) · [Troubleshooting](https://operica.ai/docs/troubleshooting) |
...
[Operica License](LICENSE) — the complete Apache License 2.0 text plus additional conditions
