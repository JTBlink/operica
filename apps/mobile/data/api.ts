 ...
 *
 * Types are imported via `import type` from @operica/core/types — zero
 * runtime coupling. Zod schemas + fallbacks are imported from
 * @operica/core/api/schemas (pure data, on the mobile sharing whitelist).
 *
 ...
 *  reasonable Operica payload size on cellular. */
