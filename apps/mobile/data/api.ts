 ...
 *
 * Types are imported via `import type` from @opercia/core/types — zero
 * runtime coupling. Zod schemas + fallbacks are imported from
 * @opercia/core/api/schemas (pure data, on the mobile sharing whitelist).
 *
 ...
 *  reasonable Opercia payload size on cellular. */
