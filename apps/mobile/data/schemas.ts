 ...
 * yet schematised in @operica/core/api/schemas. Lenient by design — see the
...
import { IssueSchema } from "@operica/core/api/schemas";
...
// availability derivation in @operica/core/agents/derive-presence. All other
...
export const EMPTY_ISSUE_FALLBACK: import("@operica/core/types").Issue = {
  id: "",
  workspace_id: "",
  number: 0,
  identifier: "",
