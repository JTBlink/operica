 ...
 * yet schematised in @opercia/core/api/schemas. Lenient by design — see the
...
import { IssueSchema } from "@opercia/core/api/schemas";
...
// availability derivation in @opercia/core/agents/derive-presence. All other
...
export const EMPTY_ISSUE_FALLBACK: import("@opercia/core/types").Issue = {
  id: "",
  workspace_id: "",
  number: 0,
  identifier: "",
