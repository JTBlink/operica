...
Compare the hash with the matching line in `checksums.txt` on the [latest release](https://github.com/JTBlink/operica/releases/latest).
...
<Callout type="warning">
Only add these exclusions if you installed Opercia from the [downloads page](https://opercia.ai/download) or [GitHub releases](https://github.com/JTBlink/operica/releases) and the checksum matches. An exclusion disables real-time protection for everything in that folder.
</Callout>
