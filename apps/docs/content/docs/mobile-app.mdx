...
For mobile development, using the Simulator, or connecting to staging, see [`apps/mobile/README.md`](https://github.com/JTBlink/operica/blob/main/apps/mobile/README.md) in the repository.
