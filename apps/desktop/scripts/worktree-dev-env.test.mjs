...
describe("worktree-dev-env", () => {
  ...
  it("never reuses 5173 even when the offset is 0", () => {
    // POSIX cksum("/tmp/opercia-3494") === 1189739000, % 1000 === 0
    expect(offsetForPath("/tmp/opercia-3494")).toBe(0);
    expect(rendererPortForPath("/tmp/opercia-3494")).toBe(5174);
    expect(rendererPortForPath("/tmp/opercia-3494")).not.toBe(5173);
  });
