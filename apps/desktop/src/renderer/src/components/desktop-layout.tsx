...
import { AppSidebar, GlobalShortcuts } from "@operica/views/layout";
import { SearchCommand, SearchTrigger } from "@operica/views/search";
import { FloatingChat } from "@operica/views/chat";
import { WorkspaceSlugProvider, paths, useCurrentWorkspace } from "@operica/core/paths";
import {
  useNavigation,
  type LinkClickIntent,
} from "@operica/views/navigation";
import { getCurrentSlug, subscribeToCurrentSlug } from "@operica/core/platform";
import { useDesktopUnreadBadge } from "@operica/views/platform";
import {
 ...
 * `operica:navigate` event, whose handler `openTab`s into the ACTIVE
