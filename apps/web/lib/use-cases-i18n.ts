...
export const useCaseText: Record<SupportedLocale, UseCaseText> = {
  en: {
    ...
    indexSubtitle:
      "See how teams organize people and agents together with Opercia.",
    indexMetadataTitle: "Use cases",
    indexMetadataDescription:
      "See how teams put people and agents to work together with Opercia.",
    cardReadMore: "Read →",
    tableOfContents: "On this page",
  },
  "zh-Hans": {
    indexTitle: "案例",
    indexSubtitle: "看看团队怎么用 Opercia 把人和 agent 一起组织起来。",
    indexMetadataTitle: "案例",
    indexMetadataDescription:
      "看看团队怎么用 Opercia 把人和 agent 一起组织起来。",
    cardReadMore: "阅读 →",
    tableOfContents: "目录",
  },
  ko: {
    indexTitle: "사용 사례",
    indexSubtitle:
      "팀이 Opercia로 사람과 에이전트를 함께 구성하는 방법을 확인해 보세요.",
    indexMetadataTitle: "사용 사례",
    indexMetadataDescription:
      "팀이 Opercia로 사람과 에이전트를 함께 일하게 만드는 방법을 확인해 보세요.",
    cardReadMore: "읽기 →",
  ...
  ja: {
    indexTitle: "ユースケース",
    indexSubtitle:
      "チームが Opercia で人とエージェントをどう組み合わせて動かしているかをご覧ください。",
    indexMetadataTitle: "ユースケース",
    indexMetadataDescription:
      "チームが Opercia で人とエージェントを一緒に働かせる方法をご覧ください。",
    cardReadMore: "続きを読む →",
