...
import { StatusIcon, PriorityIcon } from "@operica/views/issues/components";
import { STATUS_CONFIG } from "@operica/core/issues/config/status";
import { PRIORITY_CONFIG } from "@operica/core/issues/config/priority";
import type { IssueStatus, IssuePriority } from "@operica/core/types";
    ...
    <div className="relative aspect-video overflow-hidden rounded-lg border bg-background text-foreground shadow-2xl">
      ...
      <div className="flex h-10 shrink-0 items-center border-b bg-background px-4 text-body">
        <div className="flex items-center gap-1.5 min-w-0 text-caption">
          <span className="text-muted-foreground">Operica Demo</span>
...
const mockToolCalls = [
  ...
  { type: "tool_result" as const, preview: "ok  \tgithub.com/operica/server/internal/handler\t0.847s" },
];
