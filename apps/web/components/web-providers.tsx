...
import { createBrowserCookieLocaleAdapter } from "@operica/core/i18n/browser";
import type { LocaleResources, SupportedLocale } from "@operica/core/i18n";
...
// cookie mode on their next logout/login cycle (logout clears operica_token).
// Sunset: once telemetry shows <1% of sessions still carry operica_token,
...
function hasLegacyToken(): boolean {
  ...
  try {
    return Boolean(window.localStorage.getItem("operica_token"));
  } catch {
    return false;
  }
}
