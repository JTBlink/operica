...
import { createBrowserCookieLocaleAdapter } from "@opercia/core/i18n/browser";
import type { LocaleResources, SupportedLocale } from "@opercia/core/i18n";
...
// cookie mode on their next logout/login cycle (logout clears opercia_token).
// Sunset: once telemetry shows <1% of sessions still carry opercia_token,
...
function hasLegacyToken(): boolean {
  ...
  try {
    return Boolean(window.localStorage.getItem("opercia_token"));
  } catch {
    return false;
  }
}
